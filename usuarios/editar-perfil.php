...
<section class="editar-perfil containter-principal">
    <div class="container-agregar">
        ...
        <form action="procesar-editar-perfil.php" method="POST" enctype="multipart/form-data" class="form-vertical">
            <!-- Nombre -->
            ...
            <div class="form-group">
                ...
                <img src="<?php echo APP_URL . 'img/avatars/' . htmlspecialchars($avatar, ENT_QUOTES, 'UTF-8'); ?>" 
                     ...
                     width="120" style="border-radius:50%; border:2px solid #f4bf2c;">
            </div>
